...
export const cartSlice = createSlice({
  ...
  reducers: {
    addToCart: (state, action) => {
      ...
      state.totalItems = state.products.reduce((sum, { quantity }) => {
        return sum + quantity;
      }, 0);
      state.total = state.products.reduce((sum, { quantity, discountedPrice }) => {
...
export const { addToCart, removeFromCart, decreaseQuantity, clearCart, updateCart } = cartSlice.actions;
